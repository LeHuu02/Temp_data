...
/*
DE BAI: 
		Cho 1 c�y NPTK ch?a c�c s? nguy�n.
		Y�uc?u:
		
		�Bi?u di?n c�y b?i con tr?.
		�Nh?p d? li?u cho c�y.
		�Hi?n th? d? li?u tr�n c�y: theo th? t? tru?c, gi?a, sau.
		�T�m ki?m 1 d?nh c� kh�a x tr�n c�y
		�Th�m m?t kh�a x v�o c�y sao cho sau khi th�m c�y v?n l� c�y NPTK.
		�X�a d?nh c� kh�a x ra kh?i c�y cho sau khi x�a c�y v?n l� c�y NPTK.
*/
#include <stdio.h>
#include <stdlib.h>
#include <conio.h>
